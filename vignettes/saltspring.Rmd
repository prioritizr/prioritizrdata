...
The intent of this tutorial is to provide a worked example of how raster data can be incorporated into a conservation prioritization problem with _prioritizr_. For spatial shapefile input data, refer to the [Tasmania vignette](https://prioritizr.github.io/prioritizrdata/tasmania.html).
...
![Extent of Coastal Douglas-fir Conservation Partnership Tool area and location of Salt Spring Island](https://cdn.rawgit.com/prioritizr/prioritizrdata/inst/assets/Extent_map.jpg)
