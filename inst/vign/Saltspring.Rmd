...
## Introduction
This tutorial is intented to provide a worked example of how raster data can be incorporated into a conservation prioritisation problem with _prioritizr_. For vector shapefile data refer to the Tasmania vignette. 
