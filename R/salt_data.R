...
#' with this dataset, refer to the \code{{SaltSpring_Isl}} vignette. The 
#' scenario is intended to provide an example of how Raster-class input data can be used in 
#' \code{prioritizr}. The dataset contains the following data:
#' 
#' \describe{
...
#'   acquisition, based on 2015 BC Land Assessment data.}
