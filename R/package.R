...
#' example datasets and tutorials for conservation planning. It is intended to
...
#'
#' @details This package contains two datasets:
#'
#' \describe{
#'
...
#'    Refer to the \href{tasmania.html}{Tasmania vignette} for a
...
#'     the \href{saltspring.html}{Salt Spring Island vignette} for a
#'     worked example with this dataset}
#'
#' }
#'
