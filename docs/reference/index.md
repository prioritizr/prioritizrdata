...
- [`prioritizrdata`](http://prioritizr.github.io/prioritizrdata/reference/prioritizrdata.md)
  [`prioritizrdata-package`](http://prioritizr.github.io/prioritizrdata/reference/prioritizrdata.md)
  : prioritizrdata: Conservation Planning Datasets

## Data

Data sets distributed with the package
