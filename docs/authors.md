...
- **[Richard Schuster](http://www.richard-schuster.com)**. Author,
  maintainer. [](https://orcid.org/0000-0003-3191-7869)
...
- **[Peter Arcese](https://arcese.forestry.ubc.ca)**. Author.
  [](https://orcid.org/0000-0002-8097-482X)

- **Joseph R Bennett**. Author.
  [](https://orcid.org/0000-0002-3901-9513)

- **[Hugh P Possingham](http://www.possinghamlab.org)**. Author.
  [](https://orcid.org/0000-0001-7755-996X)

## Citation

Source:
[`DESCRIPTION`](https://github.com/prioritizr/prioritizrdata/blob/HEAD/DESCRIPTION)

Hanson JO, Schuster R, Morrell N, Strimas-Mackey M, Buenafe KV, Watts
ME, Arcese P, Bennett JR, Possingham HP (2026). *prioritizrdata:
Conservation Planning Datasets*. R package version 0.3.3,
